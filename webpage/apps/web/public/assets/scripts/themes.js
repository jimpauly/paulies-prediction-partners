...
(function () {
  ...
  var THEME_COLORS = {
    webpage: {
      light: { bg: "#f8f9fa", fg: "#1a1a2e", accent: "#3b82f6" },
      dark: { bg: "#1e293b", fg: "#f1f5f9", accent: "#60a5fa" },
    },
    "mosaic-1993": {
      light: { bg: "#008080", fg: "#000000", accent: "#000080" },
      dark: { bg: "#3a3a3a", fg: "#c0c0c0", accent: "#6666cc" },
    },
    "gen7-cockpit": {
      light: { bg: "#5c6053", fg: "#d8e0c8", accent: "#4fc845" },
      dark: { bg: "#111a0e", fg: "#33ff33", accent: "#33ff33" },
    },
    "ussr-cockpit": {
      light: { bg: "#3d90a2", fg: "#f0faff", accent: "#cc2200" },
      dark: { bg: "#3d90a2", fg: "#ffffff", accent: "#ff2200" },
    },
    "neon-vice-1985": {
      light: { bg: "#f0d8c8", fg: "#2a0a1a", accent: "#e8187a" },
      dark: { bg: "#160025", fg: "#f8e0f0", accent: "#ff1493" },
    },
    "neon-city-2085": {
      light: { bg: "#e4dcf8", fg: "#1a0a30", accent: "#7c3aed" },
      dark: { bg: "#10082a", fg: "#e0d8ff", accent: "#a855f7" },
    },
    coniforest: {
      light: { bg: "#e8e4d8", fg: "#1a2e14", accent: "#2d6a4f" },
      dark: { bg: "#162412", fg: "#d4e8cc", accent: "#52b788" },
    },
    rainforest: {
      light: { bg: "#dff0df", fg: "#0c2810", accent: "#059669" },
      dark: { bg: "#0c1e10", fg: "#c8f0cc", accent: "#34d399" },
    },
    "art-deco": {
      light: { bg: "#f0e8d0", fg: "#1a1408", accent: "#b8960a" },
      dark: { bg: "#141210", fg: "#f0e8c8", accent: "#d4aa00" },
    },
    holographic: {
      light: { bg: "#f0f0ff", fg: "#2a1a3a", accent: "#8b5cf6" },
      dark: { bg: "#120e1e", fg: "#e8e0ff", accent: "#a78bfa" },
    },
    vapor: {
      light: { bg: "#ffe8f4", fg: "#3a1040", accent: "#e040a0" },
      dark: { bg: "#28103a", fg: "#ffc8e8", accent: "#ff50c0" },
    },
    paper: {
      light: { bg: "#f5ede0", fg: "#2a2018", accent: "#8a4a2a" },
      dark: { bg: "#24201a", fg: "#e8dcc8", accent: "#c87a4a" },
    },
    "ledger-1920": {
      light: { bg: "#ecdcbe", fg: "#2a1e0c", accent: "#6a4a1e" },
      dark: { bg: "#100e00", fg: "#f0d860", accent: "#e8c000" },
    },
    blueprint: {
      light: { bg: "#dce8f4", fg: "#0a1a30", accent: "#1a5aa8" },
      dark: { bg: "#0e2244", fg: "#d0e4ff", accent: "#5a9aea" },
    },
    chalkboard: {
      light: { bg: "#d0dac4", fg: "#1a2a14", accent: "#3a6a2a" },
      dark: { bg: "#224028", fg: "#f0ece0", accent: "#d0ccb8" },
    },
    phosphor: {
      light: { bg: "#1a1000", fg: "#ffb300", accent: "#ffaa00" },
      dark: { bg: "#001400", fg: "#33ff33", accent: "#33ff33" },
    },
    volcano: {
      light: { bg: "#f0e0d4", fg: "#2a0e06", accent: "#d4380a" },
      dark: { bg: "#1e0e08", fg: "#ffd0b8", accent: "#ff5020" },
    },
    oceanic: {
      light: { bg: "#dceef4", fg: "#082030", accent: "#0077b6" },
      dark: { bg: "#081a2a", fg: "#c8e4f0", accent: "#48cae4" },
    },
    steampunk: {
      light: { bg: "#e4d4b8", fg: "#2a1a0a", accent: "#b87333" },
      dark: { bg: "#1e160c", fg: "#e0c898", accent: "#d4883a" },
    },
    dieselpunk: {
      light: { bg: "#d0cec8", fg: "#1a1a1a", accent: "#704a18" },
      dark: { bg: "#1c1c1a", fg: "#c8c8c4", accent: "#c87830" },
    },
    solarpunk: {
      light: { bg: "#e8f4d4", fg: "#142a08", accent: "#3a9a20" },
      dark: { bg: "#12200e", fg: "#d0eeb8", accent: "#60d840" },
    },
    stonepunk: {
      light: { bg: "#dcd4c4", fg: "#2a2018", accent: "#7a5a30" },
      dark: { bg: "#201a16", fg: "#d0c4b4", accent: "#c09050" },
    },
    dreamcore: {
      light: { bg: "#f0e4ff", fg: "#30204a", accent: "#b060d0" },
      dark: { bg: "#080408", fg: "#d8c8e8", accent: "#8820c0" },
    },
    "frutiger-aero": {
      light: { bg: "#dceefa", fg: "#0a1e3a", accent: "#0078d4" },
      dark: { bg: "#0e1e30", fg: "#d0e8fc", accent: "#40a8f0" },
    },
  };
